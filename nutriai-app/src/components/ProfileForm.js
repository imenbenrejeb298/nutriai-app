...
function ProfileForm() {
  ...
  function saveProfile(e) {
    e && e.preventDefault();
    const profile = { name, weight, height, conditions, goal };
      ...
      <section className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
        ...
        <form onSubmit={saveProfile} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <label className="block"><span className="text-gray-700 font-medium">{t('name')}</span><input type="text" className="mt-2 block w-full rounded-lg border-gray-300 shadow-sm bg-white text-gray-900 placeholder-gray-400 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value={name} onChange={(e) => setName(e.target.value)} placeholder={t('namePlaceholder')} /></label>
            <div className="grid grid-cols-2 gap-4">
              <label className="block"><span className="text-gray-700 font-medium">{t('weight')} (kg)</span><input type="number" className="mt-2 block w-full rounded-lg border-gray-300 shadow-sm bg-white text-gray-900 placeholder-gray-400 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value={weight} onChange={(e) => setWeight(e.target.value)} placeholder="70" /></label>
              <label className="block"><span className="text-gray-700 font-medium">{t('height')} (cm)</span><input type="number" className="mt-2 block w-full rounded-lg border-gray-300 shadow-sm bg-white text-gray-900 placeholder-gray-400 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value={height} onChange={(e) => setHeight(e.target.value)} placeholder="175" /></label>
            </div>
          </div>
          ...
          <div className="border rounded-lg p-4 bg-gray-50/70 mt-4">
            <h3 className="text-base font-medium text-gray-800 mb-3">{t('goal_title')}</h3>
